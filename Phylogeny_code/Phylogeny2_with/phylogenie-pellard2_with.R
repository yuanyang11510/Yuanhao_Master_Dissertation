...
#1. Préparation des données
  #1.1. Import
  url <- "https://raw.githubusercontent.com/yuanyang11510/Dissertation-Master-Codes/main/With_borrowings(3727).tsv"
  download.file(url, "Data/With_borrowings(3727).tsv")
  lx_orig <- read_tsv("Data/With_borrowings(3727).tsv", comment = "#")
  lx <- lx_orig %>%
  ...
  write.phyDat(lx_phy_bin, "Output/lx_phy_bin_with.nex", format = "nexus")
...
#3. Méthodes de maximum de parcimonie
  ...
  write.tree(lx_bab, "Output/lx_bab_with.nwk")
